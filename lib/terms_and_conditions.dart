...
class _TermsAndConditionsPageState extends State<TermsAndConditionsPage> {
  ...
  bool get _canAccept => _isAtBottom && _isChecked;
...
By using MedHive, you acknowledge that you have read, understood, and agree to these Terms and Conditions.
                  ...
                  Row(
                    children: [
                      Checkbox(
                        ...
                        activeColor: TermsAndConditionsPage.darkBrown,
                      ),
                      const Expanded(
                        child: Text(
                          'I have read and agree to the Terms & Conditions',
                          style: TextStyle(color: TermsAndConditionsPage.darkBrown),
                        ),
                      ),
                    ],
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        _canAccept ? 'Accept' : 'Scroll & Agree to Accept',
